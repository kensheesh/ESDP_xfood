...
public interface WorkScheduleService {
    ...
    WorkSchedule findWorkScheduleByManagerAndDate(Long managerId, LocalDateTime startTime,LocalDateTime endTime );

    WorkScheduleSupervisorShowDto getWorkSchedule(Long managerId, LocalDateTime startTime, LocalDateTime endTime);
}
