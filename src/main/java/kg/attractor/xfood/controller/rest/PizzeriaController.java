...
public class PizzeriaController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<PizzeriaShowDto>> getPizzeriasByPartOfName(@RequestParam(name = "query", required = false)String searchQuery) {
        List<PizzeriaShowDto> pizzerias = pizzeriaService.getPizzeriasByPartOfName(searchQuery);
        return ResponseEntity.ok(pizzerias);
    }
}
